...
* 
* The I2C protocol is a synchronous serial interface protocol. Devices operate
* in either master or slave mode.
* The communication frequency and (for slave) address can be configured via cyhal_i2c_cfg_t.
* \defgroup group_hal_i2c_common Common
...
/**
* \addtogroup group_hal_i2c_common
* \{
*/
...
#define CYHAL_I2C_RSLT_ERR_TX_RX_BUFFERS_ARE_EMPTY      \
    (CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CYHAL_RSLT_MODULE_I2C, 3))
/** Previous Async operation is pending */
#define CYHAL_I2C_RSLT_ERR_PREVIOUS_ASYNCH_PENDING      \
    (CY_RSLT_CREATE(CY_RSLT_TYPE_ERROR, CYHAL_RSLT_MODULE_I2C, 4))
 ...
 * @param[in] obj      The I2C object to configure the peri divider for
 ...
 */
uint32_t cyhal_set_peri_divider(cyhal_i2c_t *obj,  uint32_t freq, bool is_slave);
