...
/*    cyhal_i2c_event_t cause;
    ...
    uint32_t set1 = cyhal_utils_convert_flags(status_map1, sizeof(status_map1) / sizeof(uint32_t), pdl_cause & 0xFF);
    ...
    uint32_t set2 = cyhal_utils_convert_flags(status_map2, sizeof(status_map2) / sizeof(uint32_t), pdl_cause >> 16);
